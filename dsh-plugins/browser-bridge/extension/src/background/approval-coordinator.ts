/**
 * Owns pending user-approval requests independently of the side panel's
 * lifetime: delivers to any open panel, falls back to an OS notification,
 * enforces a timeout, and replays live requests to a panel that (re)connects.
 *
 * Ported unchanged from github.com/Lum1104/dsh-browser
 * (`extensions/dsh-browser/src/background/approval-coordinator.ts`).
 *
 * @module
 */
