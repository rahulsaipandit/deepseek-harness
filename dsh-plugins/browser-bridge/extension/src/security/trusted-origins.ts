/**
 * Origin-trust normalization and matching for the extension's action
 * allowlist (persistent per-origin trust and the ephemeral per-session
 * allowlist).
 *
 * Ported unchanged from github.com/Lum1104/dsh-browser
 * (`extensions/dsh-browser/src/security/trusted-origins.ts`).
 *
 * @module
 */
