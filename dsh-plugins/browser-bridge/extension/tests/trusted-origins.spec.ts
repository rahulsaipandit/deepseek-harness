...
// (`extensions/dsh-browser/tests/trusted-origins.spec.ts`), named in the port
// task as one of the security-focused specs to keep. No adaptation was
// needed: `security/trusted-origins.ts` was ported verbatim.
