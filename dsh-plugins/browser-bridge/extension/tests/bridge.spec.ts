...
// (`extensions/dsh-browser/tests/bridge.spec.ts`), named in the port task as
// one of the security-focused specs to keep. No adaptation was needed:
// `background/bridge.ts` was ported unchanged apart from its import path.
